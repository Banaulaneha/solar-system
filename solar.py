...
class SolarSystem:
    def __init__(self, width, height):  # Corrected __init__ method
        self.thesun = None
        self.planets = []
...
class Sun:
    def __init__(self, iname, irad, im, itemp):  # Corrected __init__ method
        self.name = iname
        self.radius = irad
        self.mass = im
        self.temp = itemp
...
class Planet:
    def __init__(self, iname, irad, im, idist, ivx, ivy, ic):  # Corrected __init__ method
        self.name = iname
        self.radius = irad
        self.mass = im
        self.distance = idist
